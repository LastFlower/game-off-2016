window.STORY = {
  ...
  levels: {
    1: [
      ...
      { func: 'cover' },
      { pic: 'smile', text: "From today on, I will be your partner. I'm Coody the cute robot!" },
      { func: 'startGamePreview' },
      { pic: 'idea', text: 'Now the map of BoxieHub is here on the screen.' },
      { pic: 'teach', text: 'There are some boxies on the ground. Our job is to push the boxie to the correct position.' },
      { pic: 'power', text: 'I am fully charged so that I could push any boxie no matter how heavy it is.' },
      { pic: 'smile', text: 'Your job is to watch the map and tell me how to move them.' },
      { func: 'startGame' },
    ...
    4: [
      ...
      { pic: 'teach', text: 'I have set [SDBBP] to a computer virus and refuse to receive it. You cannot use it now.' },
      { func: 'startGamePreview' },
      { pic: 'thinking', text: '...' },
      ...
      { func: 'transferPrograms' },
      { pic: 'power', text: 'I am able to pull boxies with this program!' },
      { func: 'startGame' },
      { pic: 'victory', text: 'We made it today!' },
      { pic: 'thinking', text: 'But it seems [VEJP] and [HIBPP] are not enough for more complex jobs...' }
    ],
    5: [
      { pic: 'smile', text: 'Good news! Hasky have developed [EMMBMP] and it is usable now!' },
      ...
      { func: 'startGamePreview' },
      { pic: 'sad', text: 'My memory is too small. I can only store two special programs at a time.' },
